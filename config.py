...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "sexyafraid")
...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/SexyDark/ShrutiMusic.git")
UPSTREAM_BRANCH = os.getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = os.getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/SayaProject")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/SayaProject")
INSTAGRAM = os.getenv("INSTAGRAM", "https://t.me/sexyafraid")
YOUTUBE = os.getenv("YOUTUBE", "https://t.me/sexyafraid")
GITHUB = os.getenv("GITHUB", "https://t.me/sexyafraid")
DONATE = os.getenv("DONATE", "https://t.me/sexyafraid")
PRIVACY_LINK = os.getenv("PRIVACY_LINK", "https://t.me/sexyafraid")

DURATION_LIMIT_MIN = int(os.getenv("DURATION_LIMIT", 300))
PLAYLIST_FETCH_LIMIT = int(os.getenv("PLAYLIST_FETCH_LIMIT", 255))
